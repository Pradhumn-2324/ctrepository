...
const SubNav = ({ setHideNavbar, setActiveSubNav, serviceDD, solutionsDD, techDD, industryDD }) => {
  ...
  return (
    <div
      className={`h-[50px] w-[100vw] bg-black sticky ${isAtTop ? 'top-[calc(90px + 1rem)]' : 'top-0'} z-50 md:hidden ${!serviceDD && !solutionsDD && !techDD && !industryDD ? 'flex' : 'hidden'}`}
      style={{
        top: subNavTop,
