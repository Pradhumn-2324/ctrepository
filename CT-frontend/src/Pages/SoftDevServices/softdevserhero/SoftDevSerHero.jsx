...
import softdevser from '../../HomePage/Component/assets/serviceWeOffer/softdevser.png'
const SoftDevSerHero = () => {

  return (
    <div className='w-[100vw] h-[100vh]'>
      <div className='w-full h-[100vh]'>
        <div className='w-[100vw] h-full relative' style={{ backgroundImage: `url(${softdevser})`, backgroundSize: 'cover', backgroundPosition: 'center' }} >
          <div className='w-[100%] h-[100%] absolute top-0 left-0 bg-black opacity-[0.7] flex flex-col justify-center items-start box-border px-3 gap-[46px] md:justify-evenly md:items:center'>
            <div className='flex flex-col gap-[50px] w-[100%]'>
              <h2 className='text-3xl font-semibold text-white w-[50%] ms-[110px] md:w-[90%] md:text-xl' style={{ fontFamily: 'Montserrat' }}>Software Development Services</h2>
              <p className='text-xl md:text-[16px] text-white text-left ms-[110px] w-[60%] md:w-[90%] md:mx-auto' style={{ fontFamily: 'Poppins' }}>Outsource your software development needs to us for a high-performing team that elevates your business. We provide cost-effective software development teams, eliminating the challenges of in-house management. Our experts in frontend, backend, QA, DevOps, etc., offer cutting-edge solutions.</p>
            </div>
