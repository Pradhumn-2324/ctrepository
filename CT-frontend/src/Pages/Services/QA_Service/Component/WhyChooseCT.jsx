...
const WhyChooseCT = () => {
    ...
    return (
        <div className="w-[100vw] h-[auto] py-[30px] md:py-[30px]">
            ...
            <div className="w-[85%] flex items-center justify-around mx-[100px] md:w-[100vw] md:mx-auto md:hidden">
            ...
            <div className="w-[85%] py-[30px] md:py-[30px] md:px-2 mx-auto md:w-full">
                <div className="flex gap-[10px]">
                    <div className="w-[18px] h-[18px] bg-violet-300 md:w-[13px] md:h-[14px] md:mt-[7px]"></div>
                    <p className="text-[16px]">20 years as an ecommerce solutions provider</p>
                </div>

                <div className="mt-[10px] flex gap-[10px]">
                    <div className="w-[18px] h-[18px] bg-violet-300 md:w-[px] md:w-[15px] md:h-[14px] md:mt-[7px]"></div>
                ...
                <div className="mt-[10px] flex gap-[10px]">
                    <div className="w-[18px] h-[18px] bg-violet-300 md:w-[40px] md:h-[14px] md:mt-[7px]"></div>
                    <p className="text-[16px]">
                    For the second straight year, ScienceSoft USA Corporation is listed among The Americas’ Fastest-Growing Companies by the Financial Times</p>
                </div>
            </div>
        </div>
    );
