...
import QaTestingHeader from '../../../../../assets/Services/DedicatedDevTeam/QaTesting/qaTestingHeader.png'
const Header = () => {
    return (
        <div className='w-[100vw] h-[100vh]' style={{ backgroundImage: `url(${QaTestingHeader})`, backgroundSize: 'cover' }}>
            ...
            <div className='p-[20px] text-[white] flex flex-col gap-[20px] ms-[110px] md:ms-0'>
                <h1 className='text-3xl font-semibold text-white w-[50%] md:w-[90%] md:text-2xl md:ms-[0px]'>Software QA & Testing Services</h1>
