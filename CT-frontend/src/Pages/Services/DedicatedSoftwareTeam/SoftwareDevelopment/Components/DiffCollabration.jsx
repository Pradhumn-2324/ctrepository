    ...
    return (
        <div className='w-[100vw] h-[auto] box-border py-[50px] md:py-[30px]'>
            <div className='w-[85%] mx-auto md:w-[90%]'>
                <h1 className=' font-bold mb-[40px] md:mb-[10px] text-[30px] md:text-[24px] md:ms-0 md:mt-[10px] md:text-[blue]'>Different Collaboration Scenarios for Your Software Development</h1>
                <p className='w-[95%] text-[14px] md:w-[100%] md:text-[16px]'>Collaboration Scenarios: Explore various engagement models, from in-house teams to outsourced partnerships, to tailor software development collaboration to your needs.Collaboration Scenarios: Explore various engagement models, from in-house teams to outsourced partnerships, to tailor software development collaboration to your needs.</p>
            </div>
            <div className='w-[85%] flex mx-auto flex-wrap gap-x-[30px] gap-y-[30px] mt-8'>
                {CollabSenario.map((item, index) => (
                    <div key={index} className='w-[350px] h-[200px] border border-gray-300 p-3 text-[white] pt-6' style={{backgroundColor:`#${item.bgColor}`}}>
                        <h1 className='text-[18px] w-[90%] md:w-[97%] md:text-[19px]'>{item.title}</h1>
