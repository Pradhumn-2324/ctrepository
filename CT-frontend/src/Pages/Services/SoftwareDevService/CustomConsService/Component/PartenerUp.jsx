...
const PartnerUp = () => {
    ...
    return (
        <div className='py-[60px] md:py-[30px]'>
            <h1 className='ms-[110px] font-bold mb-[40px] text-[30px] mt-[30px] md:text-[24px] md:ms-0 md:px-4 md:mt-[16px]'>Why Partner Up with CT ?</h1>
            ...
            <div className='w-[100vw] py-[30px] md:py-[30px]'>
                ...
                <div className="w-[85%] flex items-center justify-around mx-[100px] md:w-[100vw] md:mx-auto">
                    ...
                    <div className="w-[85%]">
                        <Slider ref={sliderRef} {...settingsleaders}>
                            {ctReliableForAi.map((items, i) => (
                                <div>
                                    <div
                                        className="w-[210px] h-[100px] flex justify-center items-center md:h-[70px] md:w-[90%]"
