...
import cloudAppHeader from '../../../../../assets/Services/SoftwareDevService/CloudApplication/cloudApplicationHeader.png'
const Header = () => {
  return (
    <div className='w-[100vw] h-[100vh]' style={{ backgroundImage: `url(${cloudAppHeader})`, backgroundSize: 'cover' }}>
    <div className='w-[100%] h-[100%] bg-[black] opacity-[0.6] flex items-center'>
        <div className='p-[20px] text-[white] flex flex-col gap-[20px] ms-[110px] md:ms-0'>
            <h1 className='text-3xl font-semibold text-white w-[50%] md:w-[90%] md:text-[16px] md:ms-[0px]'>Cloud application development</h1>
            <p className='text-xl font-normal md:text-[16px] text-white text-left w-[85%] md:w-full md:px-2'>Outsource your software development needs to us for a high-performing team that elevates your business. We provide cost-effective software development teams, eliminating the challenges of in-house management. Our experts in frontend, backend, QA, DevOps, etc., offer cutting-edge solutions.</p>
