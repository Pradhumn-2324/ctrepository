...
import ecommerseDevImg from '../../../../assets/Services/Ecommerse/ecommerseDev.png'
            ...
            <div className='w-[85%] flex mx-auto mt-6 justify-between md:w-[95%]'>
                ...
                <div className='w-[70%] flex gap-2 flex-wrap md:w-[100%]'>
                    {ecommerseSolutionArr.map((items, i) => {
                        return (
                            <div className='w-[40%] h-[215px] p-3 border border-[#ccc] md:w-[100%] md:border-none md:h-auto md:py-3'>
                                <h4 className='md:text-[19px]'>{items.title}</h4>
                                <p className='text-[14px] mt-1 md:mt-2'>{items.desc}</p>
                            </div>
                        )
