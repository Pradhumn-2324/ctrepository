...
import ecommerseHeader from '../../../../assets/Services/Ecommerse/ecommerseServiceHeader.png'
const Header = () => {
    return (
        <div className='w-[100vw] h-[100vh]' style={{ backgroundImage: `url(${ecommerseHeader})`, backgroundSize: 'cover' }}>
            ...
            <div className='p-[20px] text-[white] flex flex-col gap-[20px] ms-[110px] md:ms-0'>
                ...
                <p className='text-xl font-normal md:text-[18px] text-white text-left w-[85%] md:w-[90%] md:ms-0 lg:w-[97%] md:mx-auto sm:text-[15px]'>Struggling with your eCommerce venture? Let ValueCoders elevate your business and help you tackle challenges and thrive in the competitive market with our expert eCommerce solutions, including shopping carts and payment gateway integration.</p>
