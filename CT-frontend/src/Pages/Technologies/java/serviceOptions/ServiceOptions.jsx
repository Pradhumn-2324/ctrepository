...
const ServiceOptions = () => {
    return (
        <div className='w-[100vw] pt-[60px] pb-[30px] bg-[#000000] md:pb-[60px]'>
            ...
            <div className='w-[85%] md:w-[90%] flex flex-wrap justify-between mx-[110px] md:mx-[20px] md:text-[#FFFFFF] md:gap-[20px]'>
                <div className='w-[32.5%] md:w-[100%] h-[180px] md:h-auto box-border p-[15px] border border-[#fffff] md:bg-[#FF6868]'>
                ...
                <div className='w-[32.5%] md:w-[100%] h-[180px] md:h-auto box-border p-[15px] border border-[#fffff] md:bg-[#1777BC]'>
                ...
                <div className='w-[32.5%] md:w-[100%] h-[180px] md:h-auto box-border p-[15px] border border-[#fffff] md:bg-[#E751FF]'>
