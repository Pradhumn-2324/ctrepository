    ...
    return (
        <div className='w-[100vw] pb-[60px]'>
            <h1 className="text-3xl font-bold mt-[40px] mb-[50px] mx-[110px] md:mx-[20px] md:text-[24px]">
                Shortlisting Golang Application Development Companies for Your Project?
            </h1>
            ...
            <div className="paretndiv w-[85vw] md:w-[90vw] md:mx-[20px] mx-auto mt-[60px]">
                <div className="md:w-[100%] flex gap-[10px]">
                    <div className="w-[16px] h-[16px] bg-violet-300 mt-[4px]"></div>
                    <p className="md:w-[95%] text-[14px] md:text-[16px]">AI consultants and developers with 7–20 years of relevant experience and competencies in major ML technologies, frameworks, and libraries.</p>
                </div>

                <div className="md:w-[100%] mt-[10px] flex gap-[10px]">
                    <div className="w-[16px] h-[16px] bg-violet-300 mt-[4px]"></div>
                    <p className="md:w-[95%] text-[14px] md:text-[16px]">
                ...
                <div className="md:w-[100%] mt-[10px] flex gap-[10px]">
                    <div className="w-[16px] h-[16px] bg-violet-300 mt-[4px]"></div>
                    <p className="md:w-[95%] text-[14px] font-semibold md:text-[16px]">
...
export default GolangLogoSlider