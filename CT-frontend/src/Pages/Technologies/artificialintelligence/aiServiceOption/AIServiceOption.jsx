    ...
    return (
        <div className='w-[85vw] mx-[110px] py-[60px]'>
            <div className='w-[100%] mb-[30px]'>
                <h1 className='font-bold text-3xl'>Choose Your AI Service Option</h1>
                <p className='text-[14px] font-semibold mt-[20px]'>Unlock AI Potential: Navigate through CT's AI service options for tailored solutions. From natural language processing to computer vision, harness the power of AI for transformative outcomes.</p>
            </div>
