...
import artificial from "../../../HomePage/Component/assets/serviceWeOffer/artificial.png"
const AiHero = () => {
    return (
        <div className='w-[100vw] h-[100vh]'>
            <div className='w-full h-[100vh]'>
                <div className='w-[100vw] h-full relative' style={{ backgroundImage: `url(${artificial})`, backgroundSize: 'cover', backgroundPosition: 'center' }} >
                    <div className='w-[100%] h-[100%] absolute top-0 left-0 bg-black opacity-[0.6] flex flex-col justify-center items-start box-border px-3 gap-[46px] md:justify-evenly md:items:center'>
                        <div className='flex flex-col gap-[50px] w-[100%]'>
                            <h2 className='text-3xl font-semibold text-white w-[50%] ms-[110px] md:w-[90%] md:text-xl' style={{ fontFamily: 'Montserrat' }}>Artificial Intelligence (AI) Services Company</h2>
                            <p className='text-xl md:text-[16px] text-white text-left ms-[110px] w-[60%] md:w-[90%] md:mx-auto' style={{ fontFamily: 'Poppins' }}>Supercharge your business with the transformative power of AI. As a leading AI development services company, ValueCoders propels startups, agencies, and enterprises to unprecedented growth and success. Experience the limitless possibilities and boost your bottom line like never before</p>
                        </div>
