...
const AiConsultingService = () => {
    ...
    return (
        <div className='w-[100vw] h-[auto] bg-[black] box-border py-[60px] md:pt-[50px] text-[white]'>
            <div className='w-[85%] mx-[110px] md:w-[90%]'>
                <h1 className='text-3xl font-bold md:text-[16px] md:text-[blue]'>End-to-End AI Consulting Services by CT</h1>
                <p className='w-[70%] text-[14px] mt-[20px] md:w-[100%] md:text-[12px]'>The scope of CT’s AI consulting services varies depending on our customers’ business needs, maturity of the data management practices, and the current AI environment. Our AI services may include:</p>
            </div>
