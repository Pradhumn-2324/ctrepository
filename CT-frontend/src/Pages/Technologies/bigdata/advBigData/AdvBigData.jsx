    ...
    return (
        <div className='w-[85vw] mx-[110px] py-[60px]'>
            <div className='w-[100%] mb-[30px]'>
                <h1 className='font-bold text-3xl'>Our Advanced Big Data Competencies</h1>
                <p className='text-[14px] font-semibold mt-[20px]'>SCT combines big data expertise with decades-long experience in other advanced technologies to deliver end-to-end big data applications that bring maximum value to their users.</p>
            </div>
