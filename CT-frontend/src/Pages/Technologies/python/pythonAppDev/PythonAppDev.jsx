...
const PythonAppDev = () => {
    ...
    return (
        <div className='w-[100vw] pb-[30px]'>
            <h1 className="text-3xl font-bold mt-[40px] mb-[50px] mx-[110px] md:mx-[20px] md:text-[24px]">
                Shortlisting Python Application Development Companies for Your Project?
            </h1>
            ...
            <div className="paretndiv w-[85vw] md:w-[90vw] mx-auto mt-[60px]">
