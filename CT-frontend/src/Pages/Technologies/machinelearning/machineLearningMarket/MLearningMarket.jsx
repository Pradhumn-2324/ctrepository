    ...
    return (
        <div className='w-[85vw] mx-[110px] py-[60px]'>
            <h1 className="text-3xl font-bold mb-[20px]">
                Why It’s High Time to Tap into the Machine Learning Market
            </h1>
            <p className='font-semibold text-[14px] mb-[20px]'>
...
export default MLearningMarket