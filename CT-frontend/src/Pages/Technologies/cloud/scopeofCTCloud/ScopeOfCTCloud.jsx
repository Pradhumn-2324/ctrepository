...
const ScopeOfCTCloud = () => {
    ...
    return (
        <div className='w-[85vw] mx-[110px] pt-[60px] pb-[30px]'>
            <div className='w-[100%] mb-[30px]'>
                <h1 className='font-bold text-3xl'>The Scope of ScienceSoft’s Cloud Application Services</h1>
                <p className='text-[14px] font-semibold mt-[20px]'>We can provide any single service or a mix of services from the list.</p>
            </div>
