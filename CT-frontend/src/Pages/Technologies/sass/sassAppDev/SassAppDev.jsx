    ...
    return (
        <div className='w-[85vw] mx-[110px] py-[60px]'>
            <div className='w-[100%] mb-[30px]'>
                <h1 className='font-bold text-3xl'>Types of SaaS Applications We Develop</h1>
                <p className='text-[14px] font-semibold mt-[20px]'>Our solid portfolio of 3,600 projects includes solutions that enable any type of interactions, be they B2C, B2B, P2P, G2P, or corporate.</p>
            </div>
