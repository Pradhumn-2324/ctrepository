    ...
    return (
        <div className='w-[85vw] mx-[110px] py-[60px]'>
            <div className='w-[100%] mb-[30px]'>
                <h1 className='font-bold text-3xl'>How You Benefit From SaaS Development with ScienceSoft</h1>
            ...
            <div className='w-[100%] flex flex-wrap justify-between'>
                {
                    benefitsOfSassData.map((item, index) => {
                        return (
                            <div className='w-[49%] h-[180px] border border-[#fffff] mt-[20px] shadow-[4px] flex flex-col gap-[10px] pt-[15px] px-[15px] box-border' key={index}>
