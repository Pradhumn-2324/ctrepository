    ...
    return (
        <div className='w-[85vw] mx-[110px] py-[60px]'>
            <div className='w-[100%] mb-[30px]'>
                <h1 className='font-bold text-3xl'>Products & Features</h1>
                <p className='text-[14px] font-semibold mt-[20px]'>ScienceSoft provides a full set of Salesforce professional services to support your CRM strategy with an appropriate software solution.</p>
            </div>
