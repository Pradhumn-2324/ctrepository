    ...
    return (
        <div className='w-[85vw] mx-[110px] py-[60px]'>
            <div className='w-[100%] mb-[30px]'>
                <h1 className='font-bold text-3xl'>Use Cases CT Covers with Data Science Services</h1>
                <p className='text-[14px] font-semibold mt-[20px]'>Use Cases ScienceSoft Covers with Data Science Services .</p>
            </div>
