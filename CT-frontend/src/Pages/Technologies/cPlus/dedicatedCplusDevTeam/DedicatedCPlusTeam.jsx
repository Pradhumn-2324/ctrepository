...
const DedicatedCPlusTeam = () => {
    return (
        <div className='w-[100vw] pt-[60px]'>
            <h2 className='font-bold text-3xl ms-[110px] md:ms-[20px] md:text-[#3970F0] md:text-[24px]'>Dedicated development team</h2>
...
export default DedicatedCPlusTeam