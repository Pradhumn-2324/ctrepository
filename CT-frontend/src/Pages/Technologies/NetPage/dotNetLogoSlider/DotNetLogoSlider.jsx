...
const DotNetTeamLogoSlider = () => {
    ...
    return (
        <div className='w-[100vw] pb-[30px]'>
            ...
            <h1 className="text-3xl font-bold mt-[40px] mb-[50px] mx-[110px] md:mx-[20px] md:text-[#3970F0] md:text-[24px]">
...
export default DotNetTeamLogoSlider