...
import digitatlTransService from '../../../../assets/ByClientType/DigitalTransformService/DigitalTransfServHeader.png' 
const Header = () => {
    return (
        <div className='w-[100vw] h-[100vh]' style={{ backgroundImage: `url(${digitatlTransService})`, backgroundSize: 'cover' }}>
        ...
        <div className='p-[20px] text-[white] flex flex-col gap-[20px] ms-[110px]'>
            <h1 className='text-4xl font-semibold'>Web Development Services </h1>
            <p className='text-[18px] w-[90%] font-normal'>With the expertise built on 1,900+ web projects, ScienceSoft professionally designs, redesigns and continuously supports customer-facing and enterprise web apps and achieves high conversion and adoption rates.</p>
