    ...
    return (
        <div className="w-[100vw] h-[auto] mt-[100px] mb-[60px]">
            <div className='w-[85%] mx-auto md:w-[90%]'>
                <h1 className='text-3xl font-bold md:text-[16px] md:text-[blue]'>Digital Transformation Services</h1>
                <p className='w-[95%] text-[14px] mt-2 md:w-[100%] md:text-[12px]'>Custom API development services help businesses facilitate cooperation and data sharing of their custom apps with each other or with third-party apps. ScienceSoft delivers safe and well-documented APIs for your applications to seamlessly connect and collaborate with your customers, vendors partners and drive new revenues.</p>
            </div>
            <div className="w-[85%] mx-auto">
                <h1 className="text-[23px] font-bold mt-[40px] mb-[20px]">
                Meet ScienceSoft, Your Reliable Development Partner                </h1>
            </div>
...
export default DigitalTranService;
