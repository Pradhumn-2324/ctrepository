...
import webDevHeaderImage from '../../../../assets/ByClientType/StartUpWebDev/webDevHeader.png'
const Header = () => {
    return (
        <div className='w-[100vw] h-[100vh]' style={{ backgroundImage: `url(${webDevHeaderImage})`, backgroundSize: 'cover' }}>
