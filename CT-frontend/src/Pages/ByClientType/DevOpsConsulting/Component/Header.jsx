...
import devopsHeader from '../../../../assets/ByClientType/DevopsService/devopsService.png'
const Header = () => {
    return (
        <div className='w-[100vw] h-[100vh]' style={{ backgroundImage: `url(${devopsHeader})`, backgroundSize: 'cover' }}>
        ...
        <div className='p-[20px] text-[white] flex flex-col gap-[20px] ms-[110px]'>
            <h1 className='text-4xl font-semibold'>DevOps Consulting</h1>
