...
import databaseHeader from '../../../../assets/ByClientType/DataBaseDev/databaseDevHeaderImg.png'
const Header = () => {
  return (
    <div className='w-[100vw] h-[100vh]' style={{ backgroundImage: `url(${databaseHeader})`, backgroundSize: 'cover' }}>
            <div className='w-[100%] h-[100%] bg-[black] opacity-[0.6] flex items-center'>
                <div className='p-[20px] text-[white] flex flex-col gap-[20px] ms-[110px]'>
                    <h1 className='text-4xl font-semibold'>Database Development Services</h1>
