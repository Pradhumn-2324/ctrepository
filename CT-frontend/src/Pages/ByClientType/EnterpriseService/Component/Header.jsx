...
import enterPriseHeader from '../../../../assets/ByClientType/Enterprise/EntepriseHeader.png'
const Header = () => {
  return (
    <div className='w-[100vw] h-[100vh]' style={{ backgroundImage: `url(${enterPriseHeader})`, backgroundSize: 'cover' }}>
    <div className='w-[100%] h-[100%] bg-[black] opacity-[0.6] flex items-center'>
        <div className='p-[20px] text-[white] flex flex-col gap-[20px] ms-[110px]'>
            <h1 className='text-4xl font-semibold'>Enterprise software development</h1>
            <p className='text-[18px] w-[90%] font-normal'>Outsource your software development needs to us for a high-performing team that elevates your business. We provide cost-effective software development teams, eliminating the challenges of in-house management. Our experts in frontend, backend, QA, DevOps, etc., offer cutting-edge solutions.</p>
