    ...
    return (
        <div className='w-[100vw] h-[auto] box-border pt-[50px] md:pt-[50px] pb-[30px] pb-[60px]'>
            <div className='w-[85%] mx-auto md:w-[90%]'>
                <h1 className='text-3xl font-bold md:text-[16px] md:text-[blue]'>Payment Solutions ScienceSoft Delivers </h1>
                <p className='mt-2 w-[98%] mx-auto'>From simple mobile apps to large-scale multi-party networks — we create all kinds of payment solutions and securely integrate them into robust payment processing chains.</p>
