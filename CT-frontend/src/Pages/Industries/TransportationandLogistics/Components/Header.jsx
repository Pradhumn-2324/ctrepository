    ...
    return (
        <div className='w-[100vw] h-[100vh]' style={{ backgroundImage: `url(${oilgasHeader})`, backgroundSize: 'cover' }}>
            ...
            <div className='p-[20px] text-[white] flex flex-col gap-[20px] ms-[110px]'>
                <h1 className='text-4xl font-semibold'>IT Services and Software for Transportation and Logistics Companies</h1>
                <p className='text-[18px] w-[90%] font-normal'>Custom marketing software development is the service for all companies aiming to enhance their marketing initiatives. We offer 16 years of experience in marketing software development to help enterprises improve efficiency of their marketing plans and enable them with proper software.</p>
