        ...
        <div className="w-[100vw] h-[auto] py-[60px] md:py-[30px]">
            ...
            <div className="w-[85%] py-[30px] md:py-[30px] md:px-2 mx-auto md:w-full">
                ...
                <div className="mt-[10px] flex gap-[10px]">
                    <div className="w-[18px] h-[18px] bg-violet-300 md:w-[19px] md:h-[13px] md:mt-[7px]"></div>
                ...
                <div className="mt-[10px] flex gap-[10px]">
                    <div className="w-[18px] h-[18px] bg-violet-300 md:w-[37px] md:h-[13px] md:mt-[6px]"></div>
                    <p className="text-[16px]">
