...
import webPortalHeader from '../../../../assets/Solution/WebPortal/webPortalHeader.png'
const Header = () => {
    return (
        <div className='w-[100vw] h-[100vh] bg-black'  style={{ backgroundImage: `url(${webPortalHeader})`, backgroundSize: 'cover' }}>
            ...
            <div className='p-[20px] text-[white] flex flex-col gap-[20px] ms-[110px] md:ms-0 md:w-full md:px-3'>
                <h1 className='text-3xl font-semibold text-white w-[50%] md:w-[90%] md:text-2xl md:ms-[0px]'>Web Portal Development Services</h1>
                <p className='text-[18px] w-[90%] font-normal md:text-[16px]'>Since 2007, ScienceSoft provides companies in 30+ industries with consulting and practical assistance on the design and implementation of reliable financial management software.</p>
