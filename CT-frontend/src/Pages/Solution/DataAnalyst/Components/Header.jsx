...
import dataAnalystHeader from '../../../../assets/Solution/DataAnalyst/dataAnalystHeader.png'
const Header = () => {
    return (
        <div className='w-[100vw] h-[100vh]'  style={{ backgroundImage: `url(${dataAnalystHeader})`, backgroundSize: 'cover' }}>
            ...
            <div className='p-[20px] text-[white] flex flex-col gap-[20px] ms-[110px] md:ms-0 md:w-full md:px-3'>
                ...
                <p className='text-xl font-normal md:text-[16px] text-white w-[85%] '>Data analytics implies building an infrastructure for data aggregation, analysis, and reporting. 34 years in data analytics services, ScienceSoft delivers tailored business analytics solutions and helps companies plan future actions based on historical insights. https://www.scnsoft.com/services/dedicated-development-teams https://www.scnsoft.com/services/dedicated-development-teamst</p>
